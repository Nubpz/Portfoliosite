...
function setupScene(gltf) {
    ...
    //const groundMaterial = new THREE.MeshStandardMaterial({ color: 0x952121 });
    ...
    const counterClip = THREE.AnimationClip.findByName(clips, 'counter');
    const waveAction = mixer.clipAction(waveClip);
    const stumbleAction = mixer.clipAction(stumbleClip);
    const counterAction = mixer.clipAction(counterClip);
